...
fun main() {
    println(SolutionClumsy().splitArray(intArrayOf(7, 2, 5, 10, 8), 2))
    println(SolutionClumsy().splitArray(intArrayOf(1, 2, 3, 4, 5), 2))
    println(SolutionClumsy().splitArray(intArrayOf(1, 4, 4), 3))
}
